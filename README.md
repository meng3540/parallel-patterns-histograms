...
The addition of this optimization alone provides some optimization to aspects of the NSight report, however without interleaved partitioning, this optimization actually resulted in worse performance.
